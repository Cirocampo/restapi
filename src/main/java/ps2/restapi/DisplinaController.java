...
class DisciplinaController {
	...
	public DisciplinaController() {
		...
		disciplinas.add(new Disciplina(1, "Programação de Sistemas I", "PS1", "BSI", 2));
		disciplinas.add(new Disciplina(2, "Programação de Sistemas I" , "PS2", "BSI", 3));
		disciplinas.add(new Disciplina(3, "Banco de Dados", "BDD", "BSI", 3));
	}
